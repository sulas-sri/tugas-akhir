			...
			<div class="modal-content">
					...
					<div class="modal-body">
							<div class="card-content pb-4">
									<div class="row">
											<div class="col-lg-12">
													<span class="badge w-100 rounded-pill bg-warning mb-3">Ada {{ $data['studentCountWho']['notPaidThisWeek'] }} orang belum membayar pada minggu ini! <i class="bi bi-exclamation-triangle"></i></span>
											</div>
									</div>
											...
											@foreach($data['students']['notPaidThisWeek'] as $studentNotPaidThisWeek)
													<div class="col-6 col-lg-6 col-md-6">
															<div class="recent-message d-flex px-4 py-3">
																	<div class="name ms-4">
																			<h5 class="mb-1">{{ $loop->iteration }}. {{ $studentNotPaidThisWeek->name }}</h5>
