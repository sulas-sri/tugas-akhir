<div class="modal fade" id="editHeadmasterModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="#" method="POST" id="headmaster-edit-form">
					@csrf
					@method('PUT')
					<div class="row">
						<div class="col-md-12">
